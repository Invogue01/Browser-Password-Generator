...
// 3. 5 prompts in total
// 4. Validate what user selected (input) if nothing selected make an alert informing that they MUST choose
...
// d. if ONLY password length selected return ALL LOWER CASE password using ONLY lowerCase letters. Otherwise generate password according to user selected criteria.
